...
void display ( void )   // Creamos la funcion donde se dibuja
{
	...
	glPushMatrix();
		...
		glPushMatrix(); 
			...
			prisma(t_Ajedrez2.GLindex, t_agua.GLindex);
		glPopMatrix();
		...
		//Silla
		//Patas
		glTranslatef(7.0,-2.5, -2.0);
		glPushMatrix();
			glColor3f(1.0, 1.0, 1.0);
			glTranslatef(2.0, -1.75, 2.0);
			glScalef(0.4, 3.5, 0.4);
			prisma(t_madera.GLindex, t_madera.GLindex);
		glPopMatrix();
		glPushMatrix();
			glColor3f(1.0, 1.0, 1.0);
		...
		glPushMatrix();
			...
			glScalef(4.5, 0.4, 4.5);
			prisma(t_madera.GLindex, t_madera.GLindex);
		glPopMatrix();
		//respaldo
		glPushMatrix();
			glColor3f(1.0, 1.0, 1.0);
			glTranslatef(1.95, 2.4, 0.0);
			glScalef(0.5, 4.5, 4.5);
			prisma(t_madera.GLindex, t_madera.GLindex);
		glPopMatrix();*/
	glPopMatrix();
